...
*/
  ...
  this.config =
  {
    ...
    titleFontColor : (config.titleFontColor) ? config.titleFontColor : "#fff",
    ...
    valueFontColor : (config.valueFontColor) ? config.valueFontColor : "#333",
    ...
    gaugeWidthScale : (config.gaugeWidthScale) ? config.gaugeWidthScale : 0.5,
    
    // gaugeColor : string
    // background color of gauge element
    gaugeColor : (config.gaugeColor) ? config.gaugeColor : "#fff",
    ...
    // shadowOpacity : int
    // 0 ~ 1
    shadowOpacity : (config.shadowOpacity) ? config.shadowOpacity : 1,
    
    // shadowSize: int
    // inner shadow size
    shadowSize : (config.shadowSize) ? config.shadowSize : 3,
    
    // shadowVerticalOffset : int
    // how much shadow is offset from top
    shadowVerticalOffset : (config.shadowVerticalOffset) ? config.shadowVerticalOffset : 2,
    ...
    labelFontColor : (config.labelFontColor) ? config.labelFontColor : "#333",
    
    // startAnimationTime : int
    // length of initial animation
    startAnimationTime : (config.startAnimationTime) ? config.startAnimationTime : 650,
    ...
    donutStartAngle : (config.donutStartAngle) ? config.donutStartAngle : 270,
    ...
    hideMinMax : (config.hideMinMax) ? config.hideMinMax : true,
    ...
    donut : (config.donut) ? config.donut : true,
  ...
  if (this.config.donut === true) {
    ...
    // value
    valueFontSize = ((widgetH / 4.8) > 16) ? (widgetH / 3.4) : 18;
    valueX = dx + widgetW / 2;
    if(this.config.label !== '') {
      valueY = dy + widgetH / 1.75;
    } else {
      valueY = dy + widgetH / 1.7;
    }

    // label
    labelFontSize = ((widgetH / 10) > 10) ? (widgetH / 10) : 10;
    labelX = dx + widgetW / 2;
    ...
    // value
    valueFontSize = ((widgetH / 3.5) > this.config.valueMinFontSize) ? (widgetH / 6.5) : this.config.valueMinFontSize;
    valueX = dx + widgetW / 2;
    valueY = dy + widgetH / 2;
    ...
    labelX = dx + widgetW / 2;
    labelY = valueY + valueFontSize / 2 + 10;
