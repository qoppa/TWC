 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-borderimage-borderradius-boxshadow-flexbox-flexboxlegacy-multiplebgs-opacity-rgba-textshadow-cssanimations-csscolumns-generatedcontent-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-audio-video-input-inputtypes-geolocation-touch-shiv-mq-cssclasses-addtest-prefixed-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-css_boxsizing-load
 */
...
Modernizr.twcGetIEVersion = function() {
...
if (Modernizr.addTest) {
	Modernizr.addTest('ie6', function() {
		return (6 === Modernizr.twcGetIEVersion());
	});
	Modernizr.addTest('ie7', function() {
		return (7 === Modernizr.twcGetIEVersion());
	});
	Modernizr.addTest('ie8', function() {
		return (8 === Modernizr.twcGetIEVersion());
	});
	Modernizr.addTest('ie9', function() {
		return (9 === Modernizr.twcGetIEVersion());
	});
	Modernizr.addTest('ie10', function() { // future scalibility 
		return (10 === Modernizr.twcGetIEVersion());
	});
	Modernizr.addTest('ie11', function() { // future scalibility 
		return (11 === Modernizr.twcGetIEVersion());
	});
	Modernizr.addTest('ie12', function() { // future scalibility 
		return (12 === Modernizr.twcGetIEVersion());
	});
}