...
CQ.themes.wcm.Sidekick = function() {
    ...
    return {
        ...
        /**
         * The height of the Sidekick in pixels (defaults to 379).
         * @static
         * @final
         * @type Number
         */
        ...
        /**
         * The minimum height of the Sidekick in pixels (defaults to 379).
         * @static
         * @final
         * @type Number
         */
 ...
 * The theme-specific constants for {@link CQ.SuggestField}.
 * @static
 * @singleton
 */
