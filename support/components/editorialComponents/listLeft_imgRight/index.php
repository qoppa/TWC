		        ...
		        <div class="50-50 section columnControl">
		            <div class="parsys_column twc-col2_5050">
		                ...
		                <div class="parsys parsys0 twc-col2_5050-c0 parsys_column">
		                    <div class="smartLink parbase section">
								<ul class="bulleted">
									...
									<li>Nunc dignissim risus id metus. Aliquam tincidunt mauris eu risus. Aliquam tincidunt mauris eu risus.</li>
									<li>Cras ornare tristique elit.</li>
									<li>Vivamus vestibulum nulla nec ante.</li>
									<li>Praesent placerat risus quis eros.</li>
									<li>Fusce pellentesque suscipit nibh. Vivamus vestibulum nulla nec ante.</li>
		                ...
		                <div class="parsys parsys1 twc-col2_5050-c1 parsys_column">
		                    <div class="smartLink parbase section">
								<figure>
								  	<img src="../images/TWC_logo-placeholder.png" alt="TWC_logo-placeholder">
