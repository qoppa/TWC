<?php include($_SERVER['DOCUMENT_ROOT']. '/TWC/core/includes/header.php'); ?>
			...
			<header class="page-header">
				<div class="tabs">
					<ul>
						<li class="active"><a class="h5" href="#tab1">Tab 1</a></li>
						<li><a class="h5" href="#tab2">Tab 2</a></li>
					</ul>
				</div>
			</header>
			...
			<div class="twc-box-column">
				...
				<div id="tab1" class="tab-content active">
					<h3>Tab 1 Content</h3>
					<figure>
					    <img class="image-left" src="http://www.placehold.it/150x100" alt="" />
                    </figure>
				...
				<div id="tab2" class="tab-content">
					<h3>Tab 2 Content</h3>
					<figure>
					    <img class="image-right" src="http://www.placehold.it/150x100" alt="" />
                    </figure>
