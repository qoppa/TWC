        ...
        <div class="locate-stores">
    				...
    				<div class="parsys_column twc-col3_502525">
    					<div class="parsys parsys0 twc-col3_502525-c0 parsys_column">
    						<div class="parbase section">
                                ...
                                <small>Enter ZIP Code, or Street Address, City, State</small>
    					...
    					<div class="parsys parsys1 twc-col3_502525-c1 parsys_column">
    						<div class="parbase section">
                                ...
                                <div class="stores_details_map_info_distance twc-right">
                                    <span> WITHIN:</span>
    					...
    					<div class="parsys parsys1 twc-col3_502525-c2 parsys_column">
    						<div class="parbase section">
    							
                                <div class="cta omega twc-icon-after icon-angle-right twc-right">
            ...
            <div class="expandable">
                <div class="refineList">
                    <a href="#" class="cta gray mobile-full">
                    <div class="100 section columnControl">
                        <div class="parsys_column twc-col1_100-c0">
                            <div class="parsys parsys0 twc-col100_1-c0 parsys_column">
                                <div class="parbase section">
                                        <span class="twc-left  twc-icon-after icon-angle-down ">Refine Your Store List</spa>
                                </div>
                                <div class="new section"></div>
                            </div>
                        </div>
...
<!-- Possibly removing from design
        									<div class="filter-section">
        										<div class="mobile-filters-options">
        										    <div class="cta blue twc-left">
        											    <button type="submit">Apply Filters</button>
        										    </div>
        											<div class="cta blue twc-right">
